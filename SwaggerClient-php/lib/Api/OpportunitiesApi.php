...
class OpportunitiesApi
{
    ...
    public function getCharactersCharacterIdOpportunitiesWithHttpInfo($character_id, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCharactersCharacterIdOpportunities200Ok[]', $httpHeader), $statusCode, $httpHeader];
    ...
    public function getOpportunitiesGroupsGroupIdWithHttpInfo($group_id, $datasource = null, $language = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetOpportunitiesGroupsGroupIdOk', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getOpportunitiesTasksTaskIdWithHttpInfo($task_id, $datasource = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetOpportunitiesTasksTaskIdOk', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
