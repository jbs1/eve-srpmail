...
class GetCharactersCharacterIdOk implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['gender'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'gender', must be one of 'female', 'male'.";
        }
        ...
        if (!is_null($this->container['security_status']) && ($this->container['security_status'] > 10)) {
            $invalid_properties[] = "invalid value for 'security_status', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['security_status']) && ($this->container['security_status'] < -10)) {
            $invalid_properties[] = "invalid value for 'security_status', must be bigger than or equal to -10.";
        }
