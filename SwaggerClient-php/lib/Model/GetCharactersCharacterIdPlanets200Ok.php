...
class GetCharactersCharacterIdPlanets200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['num_pins'] < 1)) {
            $invalid_properties[] = "invalid value for 'num_pins', must be bigger than or equal to 1.";
        }
        ...
        if (!in_array($this->container['planet_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'planet_type', must be one of 'temperate', 'barren', 'oceanic', 'ice', 'gas', 'lava', 'storm', 'plasma'.";
        }
        ...
        if (($this->container['upgrade_level'] > 5)) {
            $invalid_properties[] = "invalid value for 'upgrade_level', must be smaller than or equal to 5.";
        }

        if (($this->container['upgrade_level'] < 0)) {
            $invalid_properties[] = "invalid value for 'upgrade_level', must be bigger than or equal to 0.";
        }
