...
class GetCharactersCharacterIdMailLabelsLabel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['color'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'color', must be one of '#ffffff', '#ffff01', '#ff6600', '#fe0000', '#9a0000', '#660066', '#0000fe', '#0099ff', '#01ffff', '#00ff33', '#349800', '#006634', '#666666', '#999999', '#e6e6e6', '#ffffcd', '#99ffff', '#ccff9a'.";
        }

        if (!is_null($this->container['label_id']) && ($this->container['label_id'] < 0)) {
            $invalid_properties[] = "invalid value for 'label_id', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['unread_count']) && ($this->container['unread_count'] < 0)) {
            $invalid_properties[] = "invalid value for 'unread_count', must be bigger than or equal to 0.";
        }
