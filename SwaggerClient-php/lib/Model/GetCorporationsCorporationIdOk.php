...
class GetCorporationsCorporationIdOk implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['faction'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'faction', must be one of 'Minmatar', 'Gallente', 'Caldari', 'Amarr'.";
        }
        ...
        if (($this->container['tax_rate'] > 1)) {
            $invalid_properties[] = "invalid value for 'tax_rate', must be smaller than or equal to 1.";
        }

        if (($this->container['tax_rate'] < 0)) {
            $invalid_properties[] = "invalid value for 'tax_rate', must be bigger than or equal to 0.";
        }
