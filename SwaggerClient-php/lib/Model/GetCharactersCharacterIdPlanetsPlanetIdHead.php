...
class GetCharactersCharacterIdPlanetsPlanetIdHead implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['head_id'] > 9)) {
            $invalid_properties[] = "invalid value for 'head_id', must be smaller than or equal to 9.";
        }

        if (($this->container['head_id'] < 0)) {
            $invalid_properties[] = "invalid value for 'head_id', must be bigger than or equal to 0.";
        }
