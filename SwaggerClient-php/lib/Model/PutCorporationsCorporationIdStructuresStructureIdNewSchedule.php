 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PutCorporationsCorporationIdStructuresStructureIdNewSchedule implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['day'] > 6)) {
            $invalidProperties[] = "invalid value for 'day', must be smaller than or equal to 6.";
        }
