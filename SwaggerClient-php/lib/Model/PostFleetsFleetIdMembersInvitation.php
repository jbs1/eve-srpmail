...
class PostFleetsFleetIdMembersInvitation implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['role'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'role', must be one of 'fleet_commander', 'wing_commander', 'squad_commander', 'squad_member'.";
        }

        if (!is_null($this->container['squad_id']) && ($this->container['squad_id'] < 0)) {
            $invalid_properties[] = "invalid value for 'squad_id', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['wing_id']) && ($this->container['wing_id'] < 0)) {
            $invalid_properties[] = "invalid value for 'wing_id', must be bigger than or equal to 0.";
        }
