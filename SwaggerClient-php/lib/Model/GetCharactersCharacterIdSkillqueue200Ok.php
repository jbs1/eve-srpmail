...
class GetCharactersCharacterIdSkillqueue200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['finished_level'] > 5)) {
            $invalid_properties[] = "invalid value for 'finished_level', must be smaller than or equal to 5.";
        }

        if (($this->container['finished_level'] < 0)) {
            $invalid_properties[] = "invalid value for 'finished_level', must be bigger than or equal to 0.";
        }
