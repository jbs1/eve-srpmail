...
foreach ($raw->row as $value) {
	if($value["issuerID"]==charid()&&$value["availability"]=="Private"&&$value["type"]=="ItemExchange"&&$value["issuerCorpID"]==corpid(charid())&&strtotime($value["dateIssued"])>strtotime('-6 hour')){
