...
if (!isset($_GET['code'])) {
    ...
    // (e.g. state).
    $authorizationUrl = $provider->getAuthorizationUrl(['scope'=>['characterContractsRead','esi-mail.organize_mail.v1','esi-mail.read_mail.v1','esi-mail.send_mail.v1', 'esi-corporations.read_corporation_membership.v1']]);
